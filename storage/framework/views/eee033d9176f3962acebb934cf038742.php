<?php $__env->startSection('title', 'Tutorial Buat Pupuk'); ?>
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-3">
                            <div class="flex gap-2">
                                ...
                                <div>
                                    ...
                                    <button @click="showGorenganModal = true" class="text-amber-700 bg-amber-100 hover:bg-amber-200 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors">
        ...
        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showGorenganModal" 
                ...
                <div class="flex justify-between items-center mb-5">
                    ...
                    <button @click="showGorenganModal = false" class="text-earth-400 hover:text-earth-600 transition-colors">
                ...
                <button @click="showGorenganModal = false" class="btn-primary w-full py-3">
                    Baik, Saya Mengerti
                </button>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Kuliah\pkm\web-edu-pocycle\pkmpm-pocycle-pnc\resources\views/tutorial/index.blade.php ENDPATH**/ ?>
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 py-10">
    ...
    <div class="text-center mb-10">
        ...
        <p class="text-earth-500 text-xl">Unggah foto galon dan masukkan suhu untuk analisis kondisi pupuk Anda</p>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('scan.store')); ?>" enctype="multipart/form-data" class="space-y-8">
        ...
        <div>
            <label class="input-label">📸 Foto Kondisi Pupuk</label>
            <p class="text-earth-400 text-base mb-3">Ambil foto cairan pupuk di dalam galon agar warna terlihat jelas</p>
            ...
            <label for="image-input" class="block cursor-pointer">
                <div class="border-3 border-dashed border-earth-300 hover:border-leaf-500 rounded-2xl p-8 text-center transition-colors bg-white">
                    ...
                    <div id="upload-placeholder">
                        ...
                        <p class="text-earth-600 text-lg font-medium mb-1">Ketuk untuk pilih foto</p>
            ...
            <div class="flex gap-3">
                ...
                <div>
                    ...
                    <ul class="text-leaf-700 text-base space-y-1">
                        ...
                        <li>• Foto dari samping agar warna cairan terlihat</li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ilham/web-edu-pkm/resources/views/scan/create.blade.php ENDPATH**/ ?>
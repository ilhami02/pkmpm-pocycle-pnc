    ...
    <div class="card card-body mb-8">
        ...
        <form method="POST" action="<?php echo e(route('profile.update')); ?>" class="space-y-5">
            ...
            <div>
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" required class="input-field">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input id="username" type="text" name="username" value="<?php echo e(old('username', $user->username)); ?>" required class="input-field">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input id="phone" type="tel" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" required class="input-field">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" name="reminder_enabled" value="1"
                               <?php echo e($user->reminder_enabled ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card card-body border-red-200">
        ...
        <form method="POST" action="<?php echo e(route('profile.destroy')); ?>" onsubmit="return confirm('Yakin ingin menghapus akun? Tindakan ini tidak bisa dibatalkan.')">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Kuliah\pkm\web-edu-pocycle\pkmpm-pocycle-pnc\resources\views\profile\edit.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('assets/Logo PKM.webp')); ?>">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center gap-2">
                    ...
                    <a href="<?php echo e(route('tutorial.index')); ?>" class="nav-link <?php echo e(request()->routeIs('tutorial.*') ? 'nav-link-active' : ''); ?>">
                        🧪 Tutorial
                    </a>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                ...
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-5 py-3 text-earth-700 hover:bg-earth-50 text-lg">🛠️ Admin Panel</a>
                                <?php endif; ?>
            ...
            <div x-show="open" x-transition class="md:hidden pb-6 border-t border-earth-200 mt-2 pt-4">
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('tutorial.index')); ?>" class="nav-link <?php echo e(request()->routeIs('tutorial.*') ? 'nav-link-active' : ''); ?>">🧪 Tutorial</a>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php if(auth()->user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.*') ? 'nav-link-active' : ''); ?>">🛠️ Admin Panel</a>
                        <?php endif; ?>

...
<div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl border border-blue-200 p-5 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="text-2xl font-bold text-blue-700"><?php echo e($stats['unverified']); ?></p>
...
<div class="bg-white rounded-2xl border border-earth-200 shadow-sm overflow-hidden">
    ...
    <div class="p-6 border-b border-earth-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <a href="<?php echo e(route('admin.scans.index', array_merge(request()->except('verification', 'page')))); ?>"
               class="px-3 py-1.5 text-xs font-medium rounded-lg transition-colors <?php echo e(!request('verification') ? 'bg-earth-800 text-white' : 'bg-earth-100 text-earth-600 hover:bg-earth-200'); ?>">
                Semua
            </a>
            <a href="<?php echo e(route('admin.scans.index', array_merge(request()->except('page'), ['verification' => 'unverified']))); ?>"
               class="px-3 py-1.5 text-xs font-medium rounded-lg transition-colors <?php echo e(request('verification') === 'unverified' ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-700 hover:bg-blue-100'); ?>">
                ⏳ Belum
            </a>
            <a href="<?php echo e(route('admin.scans.index', array_merge(request()->except('page'), ['verification' => 'verified']))); ?>"
               class="px-3 py-1.5 text-xs font-medium rounded-lg transition-colors <?php echo e(request('verification') === 'verified' ? 'bg-green-600 text-white' : 'bg-green-50 text-green-700 hover:bg-green-100'); ?>">
                ✅ Sudah
            </a>
        </div>
    </div>

...
<body class="min-h-screen bg-earth-100" x-data="{ sidebarOpen: true }">

    <div class="flex min-h-screen">

        {{-- === SIDEBAR === --}}
        <aside class="w-64 bg-earth-800 text-earth-300 flex flex-col flex-shrink-0 sticky top-0 h-screen transition-all duration-300"
